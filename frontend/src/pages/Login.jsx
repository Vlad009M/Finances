    ...
    <div style={s.container}>
      ...
      <div style={{ ...s.right, ...(isMobile && { maxWidth: '100%', padding: '24px 16px', background: '#fff' }) }}>
        <div style={{ ...s.card, ...(isMobile && { padding: '28px 20px', maxWidth: '100%', boxShadow: 'none', border: 'none' }) }}>
          <div style={{ ...s.cardLogoRow, ...(isMobile && { display: 'flex' }) }}>
...
const s = {
  ...
  dividerText: { fontSize: 12, color: '#888', textTransform: 'lowercase' },
  socialRow: { display: 'flex', gap: 12, marginBottom: 8 },
  socialBtn: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '11px', background: '#fff', border: '0.5px solid #e0e0e0', borderRadius: 8, fontSize: 14, fontWeight: 500, color: '#333', cursor: 'pointer', transition: 'background 0.2s' },
}