...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Помилка реєстрації. Спробуй інший email.')
    }
  }
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <input style={styles.input} type="text" placeholder="Ваше ім'я" value={name} onChange={e => setName(e.target.value)} required />
          ...
          <button style={styles.button} type="submit">Зареєструватись</button>
        </form>
        <p style={styles.link}>Вже є акаунт? <Link to="/login">Увійти</Link></p>
      </div>
    </div>
  )
}
